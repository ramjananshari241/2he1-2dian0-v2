...
class Clear extends external_Plugin_js_namespaceObject.PluginComponent {
    ...
    handleClick() {
        ...
        if (window.confirm && 'function' == typeof window.confirm) {
            const result = window.confirm(external_i18n_index_js_default().get('clearTip'));
    ...
    render() {
        return /*#__PURE__*/ external_react_default().createElement("span", {
            ...
            title: external_i18n_index_js_default().get('btnClear'),
