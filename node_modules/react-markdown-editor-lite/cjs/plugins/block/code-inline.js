...
class BlockCodeInline extends external_Plugin_js_namespaceObject.PluginComponent {
    static pluginName = 'block-code-inline';
    render() {
        return /*#__PURE__*/ external_react_default().createElement("span", {
            className: "button button-type-code-inline",
            title: external_i18n_index_js_default().get('btnInlineCode'),
