...
import { type EditorConfig, type EditorEvent, type EditorPlugin, type KeyboardEventListener, type Selection } from '../share/var';
import { type HtmlType } from './preview';
...
declare class Editor<C = any> extends React.Component<EditorProps<C>, EditorState> {
    ...
    static register: typeof Editor.use;
    /**
     * Unregister plugin
     * @param {any} comp Plugin component
     */
    static unuse(comp: EditorPlugin): void;
    static unregister: typeof Editor.unuse;
    /**
    ...
    componentDidUpdate(prevProps: EditorProps<C>): void;
    isComposing(): boolean;
    private getPlugins;
    private scrollScale;
