...
declare type TGetImageReturnBlurhash = IGetImageReturn["optimizedForBlurhash"];
export interface IGetBlurhashOptions extends TGetImageReturnBlurhash {
}
export declare type IGetBlurhashReturn = {
    hash: string;
} & Record<"width" | "height", number>;
export interface IGetBlurhash {
    (options: IGetBlurhashOptions): IGetBlurhashReturn;
}
export declare const getBlurhash: IGetBlurhash;
export {};
